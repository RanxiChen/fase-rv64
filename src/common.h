...
#define CACHE_LINE_LEN_BYTE (1UL<<CACHE_LINE_ADDR_OFFSET)
#define CACHE_LINE_LEN_I64 (1UL<<(CACHE_LINE_ADDR_OFFSET-3))
#define PAGE_ADDR_OFFSET (12UL)
static_assert(PAGE_ADDR_OFFSET > CACHE_LINE_ADDR_OFFSET);
#define PAGE_LEN_BYTE (1UL<<PAGE_ADDR_OFFSET)
...
#define PTE_LEAF_V (PTE_V | PTE_A | PTE_D | PTE_U)
